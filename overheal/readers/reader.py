...
By: Filip Gökstorp (Saintis-Dreadmist), 2021
"""
import os
import requests
...
if API_KEY is None:
    ...
    try:
        ...
        raise IOError("API key not found.")
...
def _get_api_request(url, **params):
    ...
    if not req.status_code == 200:
        ...
        raise IOError(f"Could not get data, status: {req.status_code}, with message: {req.text}")
